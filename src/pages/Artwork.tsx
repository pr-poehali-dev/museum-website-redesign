          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="animate-slide-up space-y-8">
              <div>
                ...
                <p className="text-2xl text-gray-700 mb-2">{artwork.artist}</p>
                <p className="text-lg text-gray-500">{artwork.year}</p>
              </div>
              ...
              <Card className="p-6 bg-gray-50 border-0">
                <h3 className="font-semibold text-lg mb-4">Детали произведения</h3>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <Icon name="Palette" size={20} className="text-primary mt-1" />
                    <div>
                      <p className="text-sm text-gray-500">Техника</p>
                      <p className="font-medium">{artwork.medium}</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <Icon name="Maximize" size={20} className="text-primary mt-1" />
                    <div>
              ...
              <Card className="p-6 bg-purple-50 border-purple-200">
                <div className="flex items-start gap-4">
                  <div className="p-3 rounded-full bg-purple-200">
                    <Icon name="Info" size={24} className="text-purple-700" />
                  </div>
                  <div>
                    <h4 className="font-semibold mb-2">Посетите музей</h4>
                    <p className="text-gray-700 mb-4">
                      Увидьте это произведение вживую в нашей галерее. Билеты доступны онлайн.
                    </p>
                    <Button variant="outline">Купить билет</Button>
                  </div>
                </div>
              </Card>
            </div>
                  ...
                  <Card className="group overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer">
                    <div className="relative h-80 overflow-hidden">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-6 text-white transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                        ...
                        <p className="text-sm opacity-90">{art.artist}</p>
                      </div>
                    </div>
                  </Card>
                </Link>
